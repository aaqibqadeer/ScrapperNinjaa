...
| `AppSidebar`        | `components/shared/AppSidebar.tsx`        | Client collapsible left nav (icons + labels, localStorage collapse state). Lead Directory subtitle on `/leads`.                                                                                                                                   | `links`, `homeHref`, `workspaces`, `activeOrgId`, `userEmail`                                         | `AppShell`                                                       |
